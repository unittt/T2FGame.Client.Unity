...
namespace Pisces.Client.Sdk
{
    ...
    public sealed partial class RequestCommand
    {
        ...
        /// </summary>
        private static RequestCommand Of(int cmdMerge, ByteString data, CommandType commandType = CommandType.Business)
        {
        ...
        public static RequestCommand Of<T>(int cmdMerge, Dictionary<int, T> data) where T : IMessage<T> 
            => Of(cmdMerge, IntKeyMap.From(data));
        ...
        public static RequestCommand Of<T>(int cmdMerge, Dictionary<long, T> data) where T : IMessage<T> 
            => Of(cmdMerge, LongKeyMap.From(data));
        ...
        public static RequestCommand Of<T>(int cmdMerge, Dictionary<string, T> data) where T : IMessage<T> 
            => Of(cmdMerge, StringKeyMap.From(data));
